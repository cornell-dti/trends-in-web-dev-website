...
[Lecture Slides](https://docs.google.com/presentation/d/168ptR-i0o7q20vPsin2gqKwweyydEVBACVANR34n3kc/edit?usp=sharing)
...
For live demos, please refer to [this repo](https://github.com/cornell-dti/trends-mono-sp25/tree/main/demos). You can clone it and run it locally to follow along with the live demo by running:

```bash
git clone https://github.com/cornell-dti/trends-mono-sp25.git
cd trends-mono-sp25/demos
pnpm install
pnpm dev
```
