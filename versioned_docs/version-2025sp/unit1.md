...
Homework: HW1 and HW2, due February 24 and March 10 respectively.

Slides: [Here](https://docs.google.com/presentation/d/1gvVJjKTwDAtdN4Mvxv_EBdRk8oV4M8cDw1Tl4vNVveM/edit?usp=sharing)

Demos: [Here, under `lec1` and `lec2`](https://github.com/cornell-dti/trends-mono-sp25/tree/main/demos)
