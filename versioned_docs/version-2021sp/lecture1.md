...
[Lecture Video](https://drive.google.com/file/d/1VCksbMae6-o_fYkHrdqa6aZrsr2_mqq6/view?usp=sharing)

[Lecture Slides](https://docs.google.com/presentation/d/1Wio16ZI8E5bF3R-RrDpQx9ePqjHIbBvGYyOVgE9MESA/edit?usp=sharing)
...
We prefer using **const** for immutability although let is also accepted. _**Never use var.**_ We'll talk more about why in Lecture 4, where we cover best-practices in
...
install `typescript` as well as `ts-node`, a package that runs TypeScript files through
...
We used the following example code. (note that TypeScript files have a `.ts` extension, as opposed to JavaScript's `.js`. This will allow VS Code to recognize that you are
coding in TS)
