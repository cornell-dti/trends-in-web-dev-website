...
Homework: HW1 and HW2, due October 1 and October 8 respectively.

Slides: [Here](https://docs.google.com/presentation/d/1W1EbsJXoxnFHdOKDRJrVUFeN9vGCEMMRV9lB2oRGZS4/edit?usp=sharing)

Demos: [Here, under `lec1` and `lec2`](https://github.com/cornell-dti/trends-mono-fa25/tree/main/demos)
